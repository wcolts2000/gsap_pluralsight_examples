      ...
      $.each(dropTarget, function(idx, spot) {
        ...
        if (spotID === dragID) {
          ...
          if (dragThing.hitTest(spot, "10%")) {
            TweenMax.to(".correct", 0.3, {
              scale: 2,
              autoAlpha: 1,
              onComplete: function() {
                TweenMax.to(".correct", 0.2, {
                  scale: 0,
                  autoAlpha: 0,
                  delay: 0.5,
                  visibility: "hidden",
            ...
            TweenMax.to(dragThing.target, 0.3, {
              x: diffLeft,
              y: diffTop,
            ...
            TweenMax.to(".tryAgain", 0.3, {
              scale: 2,
              autoAlpha: 1,
              onComplete: function() {
                TweenMax.to(".tryAgain", 0.2, {
                  scale: 0,
                  autoAlpha: 0,
                  delay: 0.5,
                  visibility: "hidden",
...
function checkTargetCount() {
  if (totalHit == totalTargets) {
    TweenLite.to(".modal", 0.3, { autoAlpha: 1 });
  }
}
